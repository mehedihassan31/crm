                            ...
                            <div class="col-lg-8">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-flat">
                                        <input type="text" name="f_image_link" value="{{ $product->f_image_link }}" class="form-control ps-0"
                                            autocomplete="off">
                                    </div>
                                </div>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-lg-8">
                                <div class="mb-3">
                                    ...
                                    <div class="input-group input-group-flat">
                                        <input type="text" name="s_image_link" value="{{ $product->s_image_link }}" class="form-control ps-0"
                                            autocomplete="off">
                                    </div>
                                </div>
                            </div>
