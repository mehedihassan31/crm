		...
		<tbody>
			<tr>
				<td align="center" valign="center" style="text-align:center; padding: 40px">
					<a href="https://spacecats.tech/" rel="noopener" target="_blank">
						<img alt="Logo"  height="30%"  width="30%" src="https://spacecats.tech/wp-content/uploads/2022/09/logo-e1662601040844.png" />
					</a>
				</td>
			</tr>
			<tr>
				<td align="left" valign="center">
					<div style="text-align:left; margin: 0 20px; padding: 40px; background-color:#ffffff; border-radius: 6px">
						...
						<div style="padding-bottom: 30px; font-size: 17px;">
							<strong>Welcome to {{ config('app.name', 'Spacecats') }}!</strong>
						</div>
						...
						<div style="padding-bottom: 50px; word-wrap: break-all;">
							<p style="margin-bottom: 10px;">If otp is not working please conatct with dev team</p>
						...
						<tr>
							<td align="center" valign="center" style="font-size: 13px; text-align:center;padding: 20px; color: #6d6e7c;">
								<p>test, 10050, USA.</p>
								<p>Copyright &copy;
								<a href="" rel="noopener" target="_blank">Spacecats</a>.</p>
							</td>
						</tr></br></div>
					</div>
				</td>
